      ...
      return function(model, url, actions) {
        ...
        createAction = function(action) {
          return function(a1, a2, a3, a4) {
            ...
            value = action.isArray ? new ResourceCollection(resourceClass, action.filter) : instCall ? this : new resourceClass(data);
        ...
        ResourceCollection = function(resourceClass, filter) {
          var collection;
          if (filter == null) {
            filter = function() {
              return true;
          ...
          collection._msgHandler = function(msg) {
            ...
            if (msg.verb === 'create' && !filter(msg.data)) {
              return false;
            }
            return $rootScope.$apply(function() {
