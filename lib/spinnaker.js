      ...
      return function(model, url, actions) {
        ...
        createAction = function(action) {
          return function(a1, a2, a3, a4) {
            ...
            value = action.isArray ? new ResourceCollection(resourceClass, params, action.filter) : instCall ? this : new resourceClass(data);
        ...
        ResourceCollection = function(resourceClass, params, filter) {
          var collection;
          if (filter == null) {
            filter = function() {
              return true;
          ...
          collection._msgHandler = function(msg) {
            ...
            if (msg.verb === 'create' && !filter(msg.data, params)) {
              return false;
            }
            return $rootScope.$apply(function() {
              var i, r, rem, _i, _j, _len, _len1, _results;
              switch (msg.verb) {
                case 'create':
                  if (filter(msg.data)) {
